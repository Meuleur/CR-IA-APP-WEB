...
export default function Dashboard() {
    ...
    const currentDate = new Date().toLocaleDateString("fr-FR"); // JJ/MM/AAAA
    // Récupère le nom/email depuis ton store (ex: tu as l’email au login)
    // … dans ton composant:
    const email = useAuth((s) => s.email) ?? "utilisateur";

    async function downloadWord() {
        if (!report.trim()) return;
        const body = {
            report_md: report,
            author: email,          // ou un nom si tu l’as
    ...
    async function copyReport() {
        ...
        try {
            ...
            // petit feedback visuel simple (tu peux remplacer par un toast)
                ...
                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div className="p-4 md:p-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            {/* COL 2 — Actions export + Aperçu (sticky sur desktop) */}
